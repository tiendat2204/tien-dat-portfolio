...
export const DATA = {
  ...
  education: [
    ...
    Achieved <LinkPreview height={50} width={500} url='#' isStatic imageSrc='/js-talent.jpg' className="font-bold underline">
      3rd place in JS Talent competition
    </LinkPreview>{" "}
          for front-end development skills
  </span>,
        <span key="golden-bee" title='Golden Bee Award'>
    Awarded <LinkPreview url="#" height={50} width={500} isStatic imageSrc='/gold-bee.jpg' className="font-bold underline">
