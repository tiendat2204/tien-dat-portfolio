  ...
  awards: [
    {
      ...
      image: '/awards/nextjs-seo.jpg',
      links: [
        {
          title: 'Certificate',
          icon: <Icons.Vercel className='h-4 w-4' />,
          href: 'https://nextjs.org/learn/certificate?course=dashboard-app&user=70757&certId=dashboard-app-70757-1749911006822',
        },
      ],
    },
    {
